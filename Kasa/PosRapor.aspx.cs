...
public partial class Kasa_PosRapor : System.Web.UI.Page
{
    ...
    {
        PosHareketListesiniGetir();
        PosHareketToplamlariGetir();
    }

    protected void PosHareketListesiniGetir()
    {
        DateTime ilktarih = Convert.ToDateTime(txt_bas_tarih.Text);
        DateTime sontarih = Convert.ToDateTime(txt_son_tarih.Text);
        string queryString = "SELECT * FROM banka_pos_hareket WHERE pos_id=" + dd_pos.SelectedValue + " and (kayit_tarihi BETWEEN '" + ilktarih + "' and '" + sontarih + "') ";
        if (dd_giris_or_cikis.SelectedValue != "tum")
        { queryString += " and giris_or_cikis='" + dd_giris_or_cikis.SelectedValue + "'"; }

        queryString += " ORDER BY kayit_tarihi DESC,pos_hareket_id DESC";
        ...
        {
            lbl_mesaj.Text = "Error POS HAREKET LİSTELEME ";
    ...
    protected void PosHareketToplamlariGetir()
    {
        ...
        string queryStringGiren = "SELECT sum(tutar) AS giren FROM banka_pos_hareket WHERE giris_or_cikis='giris' and pos_id='" + dd_pos.SelectedValue + "' and (kayit_tarihi BETWEEN '" + ilktarih + "' and '" + sontarih + "')";
        ...
        {
            lbl_mesaj.Text = "Error POS Hesaplama Giriş. ";
            lbl_mesaj.Text += err.Message;
        }
        finally
        {
        ...
        string queryStringCikan = "SELECT sum(tutar) AS cikan FROM banka_pos_hareket WHERE giris_or_cikis='cikis' and pos_id='" + dd_pos.SelectedValue + "' and (kayit_tarihi BETWEEN '" + ilktarih + "' and '" + sontarih + "')";
        ...
        {
            lbl_mesaj.Text = "Error POS Hesaplama Çıkış. ";
            lbl_mesaj.Text += err.Message;
        }
        finally
        {
        ...
        {
            lbl_mesaj.Text = "Error POS GirisCikisToplaminiGetir. ";
            lbl_mesaj.Text += err.Message;
        }
