...
public partial class Kasa_BankaRapor : System.Web.UI.Page
{
    ...
    {
        BankaHareketListesiniGetir();
        BankaHareketToplamlariGetir();
    }

    protected void BankaHareketListesiniGetir()
    {
        DateTime ilktarih = Convert.ToDateTime(txt_bas_tarih.Text);
        DateTime sontarih = Convert.ToDateTime(txt_son_tarih.Text);
        string queryString = "SELECT * FROM banka_hareket WHERE banka_hesap_id=" + dd_banka.SelectedValue + " and (kayit_tarihi BETWEEN '" + ilktarih + "' and '" + sontarih + "') ";
        if (dd_giris_or_cikis.SelectedValue != "tum")
        { queryString += " and giris_or_cikis='" + dd_giris_or_cikis.SelectedValue + "'"; }

        queryString += " ORDER BY kayit_tarihi DESC,banka_hareket_id DESC";
    ...
    protected void BankaHareketToplamlariGetir()
    {
        ...
        string queryStringGiren = "SELECT sum(tutar) AS giren FROM banka_hareket WHERE giris_or_cikis='giris' and banka_hesap_id='" + dd_banka.SelectedValue + "' and (kayit_tarihi BETWEEN '" + ilktarih + "' and '" + sontarih + "')";
        ...
        string queryStringCikan = "SELECT sum(tutar) AS cikan FROM banka_hareket WHERE giris_or_cikis='cikis' and banka_hesap_id='" + dd_banka.SelectedValue + "' and (kayit_tarihi BETWEEN '" + ilktarih + "' and '" + sontarih + "')";
