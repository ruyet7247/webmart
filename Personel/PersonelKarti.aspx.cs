...
public partial class Personel_PersonelKarti : System.Web.UI.Page
{
    ...
    protected void CariEkle()
    {
        ...
        try
        {
            ...
            cmd.Parameters.Add("@tc_no", SqlDbType.NVarChar).Value = txt_banka_adi.Text;
            cmd.Parameters.Add("@meslek", SqlDbType.NVarChar).Value = txt_banka_hesap_no.Text;
            ...
            cmd.Parameters.Add("@vergi_dairesi", SqlDbType.NVarChar).Value = txt_ehliyet_belge_no.Text;
            cmd.Parameters.Add("@vergi_no", SqlDbType.NVarChar).Value = txt_gsm.Text;
            cmd.Parameters.Add("@banka_adi", SqlDbType.NVarChar).Value = txt_banka_iban_no.Text;
            cmd.Parameters.Add("@banka_hesap_no", SqlDbType.NVarChar).Value = txt_odenen_maas.Text;
            cmd.Parameters.Add("@banka_iban_no", SqlDbType.NVarChar).Value = txt_ilce.Text;
            cmd.Parameters.Add("@tel1", SqlDbType.NVarChar).Value = txt_il.Text;
            cmd.Parameters.Add("@tel2", SqlDbType.NVarChar).Value = txt_tc.Text;
            cmd.Parameters.Add("@fax", SqlDbType.NVarChar).Value = txt_cinsiyet.Text;
        ...
        try
        {
            ...
            if (reader.HasRows)
            {
                while (reader.Read())
                {
                    ...
                    txt_banka_adi.Text = reader["tc_no"].ToString();
                    txt_banka_hesap_no.Text = reader["meslek"].ToString();
                    ...
                    txt_ehliyet_belge_no.Text = reader["vergi_dairesi"].ToString();
                    txt_gsm.Text = reader["vergi_no"].ToString();
                    txt_banka_iban_no.Text = reader["banka_adi"].ToString();
                    txt_odenen_maas.Text = reader["banka_hesap_no"].ToString();
                    txt_ilce.Text = reader["banka_iban_no"].ToString();
                    txt_il.Text = reader["tel1"].ToString();
                    txt_tc.Text = reader["tel2"].ToString();
                    txt_cinsiyet.Text = reader["fax"].ToString();
